...
var jxmstc=new KBOperate("product");
...
function find() {
    jxmstc.findForEasyui("dgProduct",getCondition());
}
...
$(function () {
    ...
    jxmstc.browserForEasyui(function (obj) {
        ...
        var toUrl=getRootPath()+"/admin/web/product/product.jsp?type=2&id="+obj.id;
        layer.open({
            title:'产品库存信息浏览',
            type: 2,
            area:["100%","100%"],
    ...
    jxmstc.editForEasyui(function (obj) {
        var toUrl=getRootPath()+"/admin/web/product/product.jsp?type=1&id="+obj.id;
        layer.open({
            title:'产品库存信息修改',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnAdd").click(function () {
        var toUrl=getRootPath()+"/admin/web/product/product.jsp?type=0";
        layer.open({
            title:'产品库存信息新增',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnDeleteAll").click(function () {
        var ids=jxmstc.getEasyuiGridSelectRowsID("dgProduct");
        if (ids=="") return;
        var obj=new Object();
        obj.ids=ids;
