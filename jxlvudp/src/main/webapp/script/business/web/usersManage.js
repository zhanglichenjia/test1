var jxmstc=new KBOperate("users");
...
function find() {
    jxmstc.findForEasyui("dgUsers",getCondition());
}
...
$(function () {
    ...
    jxmstc.browserForEasyui(function (obj) {
        ...
        var toUrl=getRootPath()+"/admin/web/users/users.jsp?type=2&id="+obj.id;
        layer.open({
            title:'顾客信息浏览',
            type: 2,
            area:["100%","100%"],
    ...
    jxmstc.editForEasyui(function (obj) {
        var toUrl=getRootPath()+"/admin/web/users/users.jsp?type=1&id="+obj.id;
        layer.open({
            title:'顾客信息修改',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnAdd").click(function () {
        var toUrl=getRootPath()+"/admin/web/users/users.jsp?type=0";
        layer.open({
            title:'顾客信息新增',
            type: 2,
            area:["100%","100%"],
    ...
    $("#btnDeleteAll").click(function () {
        var ids=jxmstc.getEasyuiGridSelectRowsID("dgUsers");
        if (ids=="") return;
        var obj=new Object();
        obj.ids=ids;
