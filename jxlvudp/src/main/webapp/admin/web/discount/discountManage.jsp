...
<table class="easyui-datagrid" title="会员管理" style="height:auto" id="dgDiscount"
    ...
    <tr>
        ...
        <th data-options="field:'name',width:180">折扣名称</th>
        <th data-options="field:'integral',width:200">积分</th>
        <th data-options="field:'discount',width:200">所享受的折扣</th>
        <th data-options="field:'description',width:200">折扣描述</th>
