...
import kesun.bll.web.impl.EmpServiceImpl;
...
@Controller
@RequestMapping("emp")
public class EmpController extends SuperController implements INotice {
    @Resource(name = "bEmp")
    private EmpServiceImpl bll;
