...
import kesun.bll.web.impl.BuyProductServiceImpl;
...
public class BuyProductController extends SuperController{
    @Resource(name = "bBuyProduct")
    private BuyProductServiceImpl bll;
    ...
    public String index(){
        return "web/buyProduct/buyProductManage";
    }
