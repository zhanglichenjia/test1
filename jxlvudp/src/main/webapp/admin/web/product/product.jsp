...
<form class="layui-form" id="ff">
   ...
   <%--<div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="name" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入产品名称" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block"style="width:500px;">
            <input name="description" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入产品描述" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">所在商家名称： </label>
        <div class="layui-input-block"style="width:500px;">
...
<script>
    ...
    kb.doFormLayui("formDemo",function () {
     ...
     $(function () {
         ...
         doData("Business/find",null,function (data) {
             ...
             if(type!=0)
                 kb.getMe(getURLParamValue("id"),function (data) {
                     ...
                     $("#sltWeb").find("option[value='"+data.bus.id+"']").attr("selected","selected");
