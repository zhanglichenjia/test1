...
import kesun.bll.web.impl.UsersServiceImpl;
...
public class UsersController extends SuperController implements INotice {
    @Resource(name = "bUsers")
    private UsersServiceImpl bll;
    public SuperService getService() {
        return bll;
    }
    @RequestMapping("/index")
    public String index(){
        return "web/users/usersManage";
    }
