...
import kesun.bll.web.impl.DiscountServiceImpl;
...
public class DiscountController extends SuperController{
    @Resource(name = "bDiscount")
    private DiscountServiceImpl bll;
    ...
    public String index(){
        return "web/discount/discountManage";
    }
