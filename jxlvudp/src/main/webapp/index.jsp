...
<div data-options="region:'west',split:false,collapsible:true,title:'导航菜单'"
    ...
    <div id="dMyMenu" class="easyui-accordion"  style="width:196px;">
        ...
        <div title="会员管理" style="width:195px;" class="nav_wj">
            <a href="#"><li class="li_bian" id="discount">会员管理</li></a>
        </div>
        <div title="加盟商管理" style="width:195px;" class="nav_wj">
            <a href="#"><li class="li_bian" id="school">学校管理</li></a>
            <a href="#"><li class="li_bian" id="Business">加盟管理</li></a>
        </div>
        <div title="人员管理" style="width:195px;" class="nav_wj">
        ...
        <div title="订单管理" style="width:195px;" class="nav_wj">
