...
<form class="layui-form" id="ff">
    ...
    <div class="layui-input-block"style="width:500px;">
        <input name="password" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入测试密码" class="layui-input" type="text">
    </div>
</div>
    <br/>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block"style="width:500px;">
            <input name="age" required style="width:500px;" lay-verify="required" autocomplete="off" placeholder="请输入测试年龄" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
